...
| Curated report packs | [Reports Hub](reports/index.md) | preview-first Excel and CSV outputs for standard financial, managerial, and audit reporting | [Financial Reports](reports/financial.md), [Managerial Reports](reports/managerial.md), [Audit Reports](reports/audit.md) | sample-table preview before download |
...
- Use [Reports Hub](reports/index.md) when you want a curated preview-and-download layer before moving into raw SQL.
