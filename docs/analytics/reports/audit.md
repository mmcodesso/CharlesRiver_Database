...
<ReportCatalog
  ...
  helperText="These reports focus on reviewable control outputs such as approval coverage, payroll and time-control exceptions, segregation-of-duties logic, and broad anomaly screening."
/>
